<?php
require_once dirname(__FILE__) . '/../../../vendor/profideo/Calculation.php';

$cell1 = 'A1';
$cell2 = 'B1';
$cell3 = 'C1';
//$formula = "=COS(180)";
$formula = '=SI(COS(180)<12,"toto","tata")';
$calculate = false;
try {
...
$value = PHPExcel_Calculation::getInstance()->_calculateFormulaValue($formula);
echo " ====> " . $value . " <==== ";
